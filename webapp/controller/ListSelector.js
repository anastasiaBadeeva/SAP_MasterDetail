sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("jetCources.MasterDetail.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias jetCources.MasterDetail.controller.ListSelector
			 */
			 ...
			 * @return {jetCources.MasterDetail.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
