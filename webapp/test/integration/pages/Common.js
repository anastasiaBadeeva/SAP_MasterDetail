sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("jetCources/MasterDetail/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("jetCources.MasterDetail.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["jetCources/MasterDetail/localService/mockserver"], function (mockserver) {
